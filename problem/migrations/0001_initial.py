    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('under_comment_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='under_comments', to='problem.solutioncomment')),
            ],
            options={
